...
function transformFromTransform(transform) {
  ...
  if (transform.attributes['_t'] !== undefined) {
    var values = transform.attributes['_t'].split(' ');

    trans.position.x = values[0] * 1;
    trans.position.y = values[2] * 1;
    trans.position.z = values[1] * 1;
  }
...
exports.construct = constructMVSceneGraph;